...
class VectorDatabaseInterface(ABC):
    ...
    @abstractmethod
    def store_document(self, document_data: Dict[str, Any], collection_name: str = "default") -> str:
        """Store a document with embeddings in the vector database."""
        pass
    
    @abstractmethod
    def query_similar(self, query_text: str, collection_name: str = "default", n_results: int = 5) -> List[Dict[str, Any]]:
        """Query for similar documents based on text similarity."""
        pass
    
    @abstractmethod
    def get_document(self, document_id: str, collection_name: str = "default") -> Optional[Dict[str, Any]]:
...
class ChromaVectorDatabase(VectorDatabaseInterface):
    ...
    def store_document(self, document_data: Dict[str, Any], collection_name: str = "scraped_content") -> str:
        """
        ...
        try:
            ...
            preferred_order = ["content_embedding", "description_embedding", "title_embedding"]
            ...
            logger.info(f"Stored document with ID: {doc_id} in collection: {collection_name}")
            return doc_id
    ...
    def query_similar(self, query_text: str, collection_name: str = "scraped_content", n_results: int = 5) -> List[Dict[str, Any]]:
        """
    ...
    def get_document(self, document_id: str, collection_name: str = "scraped_content") -> Optional[Dict[str, Any]]:
        """
    ...
    def delete_document(self, document_id: str, collection_name: str = "scraped_content") -> bool:
...
class VectorDatabaseManager:
    ...
    def store_document_with_embeddings(self, document_data: Dict[str, Any], collection_name: str = "scraped_content") -> str:
        """Store a document with embeddings."""
        return self.db.store_document(document_data, collection_name)
    
    def search_similar(self, query: str, collection_name: str = "scraped_content", limit: int = 5) -> List[Dict[str, Any]]:
        """Search for similar documents."""
        return self.db.query_similar(query, collection_name, limit)
    
    def get_document_by_id(self, doc_id: str, collection_name: str = "scraped_content") -> Optional[Dict[str, Any]]:
    ...
    def remove_document(self, doc_id: str, collection_name: str = "scraped_content") -> bool:
        """Remove a document."""
